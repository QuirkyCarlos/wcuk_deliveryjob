...
Citizen.CreateThread(function()
	...
	TriggerServerEvent('wcuk_deliveryjob:fetchCompanyID')
end)
...
RegisterNetEvent('wcuk_deliveryjob:ShowAdvancedNotifyESX')
AddEventHandler('wcuk_deliveryjob:ShowAdvancedNotifyESX', function(title, subject, msg, icon, iconType)
...
RegisterNetEvent('wcuk_deliveryjob:ShowNotifyESX')
AddEventHandler('wcuk_deliveryjob:ShowNotifyESX', function(msg)
	ShowNotifyESX(msg)
end)
